...
The structural barriers arise from design choices in how research artifacts are produced and shared. We use \textit{research artifacts} to refer broadly to the tangible outputs of research: papers, datasets, code repositories, benchmarks, computational notebooks, knowledge graphs, and experimental protocols. These artifacts serve as vessels for knowledge---they encode claims, evidence, methodological context, and the provenance of results. The degree to which knowledge accumulates over time depends fundamentally on the properties of these artifacts: whether claims are extractable, evidence is traceable, artifacts remain usable beyond publication, and communities can collaboratively build upon prior work.

Addressing the diagnosed barriers requires reconsidering fundamental artifact properties. We articulate four technology-agnostic principles describing properties that systems, tools, or practices aiming to support knowledge accumulation should strive for. Implementations will vary across domains, but these principles provide a shared foundation for evaluating research infrastructure.
...
\textbf{Principle:} Research artifacts should preserve the full provenance of claims---from raw data through methodological decisions to final results---and make this provenance inspectable (\ie accessible and understandable by other researchers who wish to examine, verify, or build upon the work).
